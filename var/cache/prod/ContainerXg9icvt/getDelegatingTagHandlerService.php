...
$a->setLogger(${($_ = isset($this->services['monolog.logger.pimcore']) ? $this->services['monolog.logger.pimcore'] : $this->load(__DIR__.'/getMonolog_Logger_PimcoreService.php')) && false ?: '_'});
