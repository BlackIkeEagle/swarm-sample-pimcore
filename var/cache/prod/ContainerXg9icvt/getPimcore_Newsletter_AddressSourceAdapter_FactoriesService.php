...
// Returns the private 'pimcore.newsletter.address_source_adapter.factories' shared autowired service.
...
return $this->services['pimcore.newsletter.address_source_adapter.factories'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('csvList' => function () {
    ...
    return ${($_ = isset($this->services['pimcore.document.newsletter.factory.report']) ? $this->services['pimcore.document.newsletter.factory.report'] : $this->load(__DIR__.'/getPimcore_Document_Newsletter_Factory_ReportService.php')) && false ?: '_'};
}));
