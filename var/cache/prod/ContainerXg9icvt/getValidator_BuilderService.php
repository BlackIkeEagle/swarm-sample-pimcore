...
$instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Symfony\\Cmf\\Bundle\\RoutingBundle\\Validator\\Constraints\\RouteDefaultsTemplatingValidator' => function () {
    return ${($_ = isset($this->services['cmf_routing.validator.route_defaults']) ? $this->services['cmf_routing.validator.route_defaults'] : $this->load(__DIR__.'/getCmfRouting_Validator_RouteDefaultsService.php')) && false ?: '_'};
...
$instance->addXmlMappings(array(0 => '/phpapp/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
