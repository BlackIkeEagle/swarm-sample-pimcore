...
return $this->services['pimcore.analytics.google.fallback_service_locator'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('Pimcore\\Analytics\\Google\\Config\\SiteConfigProvider' => function () {
    return ${($_ = isset($this->services['Pimcore\Analytics\Google\Config\SiteConfigProvider']) ? $this->services['Pimcore\Analytics\Google\Config\SiteConfigProvider'] : $this->load(__DIR__.'/getSiteConfigProviderService.php')) && false ?: '_'};
