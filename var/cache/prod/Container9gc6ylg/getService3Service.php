...
return $this->services['Pimcore\DataObject\Import\Service'] = new \Pimcore\DataObject\Import\Service(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->getDoctrine_Dbal_DefaultConnectionService()) && false ?: '_'}, new \Symfony\Component\DependencyInjection\ServiceLocator(array('code' => function () {
    return ${($_ = isset($this->services['Pimcore\DataObject\Import\Resolver\Code']) ? $this->services['Pimcore\DataObject\Import\Resolver\Code'] : $this->load(__DIR__.'/getCodeService.php')) && false ?: '_'};
}, 'filename' => function () {
    return ${($_ = isset($this->services['Pimcore\DataObject\Import\Resolver\Filename']) ? $this->services['Pimcore\DataObject\Import\Resolver\Filename'] : $this->load(__DIR__.'/getFilenameService.php')) && false ?: '_'};
}, 'fullpath' => function () {
    return ${($_ = isset($this->services['Pimcore\DataObject\Import\Resolver\Fullpath']) ? $this->services['Pimcore\DataObject\Import\Resolver\Fullpath'] : $this->load(__DIR__.'/getFullpathService.php')) && false ?: '_'};
}, 'getBy' => function () {
    return ${($_ = isset($this->services['Pimcore\DataObject\Import\Resolver\GetBy']) ? $this->services['Pimcore\DataObject\Import\Resolver\GetBy'] : $this->load(__DIR__.'/getGetByService.php')) && false ?: '_'};
}, 'id' => function () {
    ...
    return ${($_ = isset($this->services['pimcore.data_object.import.operator.factory.locale_switcher']) ? $this->services['pimcore.data_object.import.operator.factory.locale_switcher'] : $this->load(__DIR__.'/getPimcore_DataObject_Import_Operator_Factory_LocaleSwitcherService.php')) && false ?: '_'};
}, 'ObjectBrickSetter' => function () {
    return ${($_ = isset($this->services['pimcore.data_object.import.operator.factory.object_brick_setter']) ? $this->services['pimcore.data_object.import.operator.factory.object_brick_setter'] : $this->load(__DIR__.'/getPimcore_DataObject_Import_Operator_Factory_ObjectBrickSetterService.php')) && false ?: '_'};
}, 'PHPCode' => function () {
