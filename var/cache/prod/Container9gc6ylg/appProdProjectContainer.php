...
protected function createProxy($class, \Closure $factory)
{
    ...
    {
        if ($lazyLoad) {
            return $this->services['Pimcore\Templating\Helper\Navigation'] = $this->createProxy('Navigation_db8414e', function () {
                return \Navigation_db8414e::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
